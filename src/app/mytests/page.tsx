      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          <div className="px-4 py-3 border-b flex justify-between items-center">
            <div className={`font-medium ${getStatusColor('active')}`}>Active</div>
            <div className="text-sm text-gray-500">Created: Jan 1, 2024</div>
            <div className="relative">
              {/* <DotsVerticalIcon className="h-5 w-5 cursor-pointer text-gray-600" /> */}
              {/* Dropdown menu for clone/delete would go here */}
              <div className="relative">
                  <button
          ...
          <div className="p-4">
            <h3 className="font-bold text-lg truncate">
              Mathematics Final Examination 2024
            </h3>
            <p className="text-gray-600 text-sm mt-2 line-clamp-2">
              This is a comprehensive test covering all topics from the semester including algebra, calculus, and geometry.
            </p>
          </div>
